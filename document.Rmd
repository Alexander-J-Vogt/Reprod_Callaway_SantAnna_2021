...
$$
Y_{g, t}=\underbrace{\alpha_t+\alpha_g}_{Time \ \&\ Unit \ FE}+ \underbrace{\sum_{e=-K}^{-2} \delta_e^{\text {anticip }} \cdot D_{g, t}^e}_{Pre-trend \ \ Effects}+ \underbrace{\sum_{e=0}^L \beta_e \cdot D_{g, t}^e+v_{g, t}}_{Treatment \ Effects}
$$
