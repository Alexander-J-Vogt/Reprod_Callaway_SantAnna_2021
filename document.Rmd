...
calculating_agg_att <- function(data,
  ...
  for (g in grouplist) {
     for (t in timelist) {
      ...
      # In the next step, the two-year dataset gets further restricted by only
      # including the treatment group of the current outer-loop and the
      # "never-treated" group. Therefore, a index-indicator is need in order to
      ...
      # The final step is to compute the conditional and unconditional ATT(g,t)
