...
if (method == "calendar_att") {
 ...
 # effects are calculated by taking the sum of ATT(g,t) of one year with the 
 # corresponding weights of each group. This is done for each post-treatment period.
   
 # Selecting the ATT(g,t) of each group in the post-treatment.
 aggte_ct <- attgt_probs_df[index_post,]

 # The calendar time effects are calculated by looping over all unique calendar
 # times and, hence, the unique calendar times need to be determined.
 ...
 for (i in seq_along(calendar_timelist)) {
  # First, all ATT(g,t) of the current calendar-time-iteration is selected 
