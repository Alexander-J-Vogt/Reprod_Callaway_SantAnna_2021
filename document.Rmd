...
In the next step, the regional effects of the conditional ATE are discussed on how they differ to the results of the full sample. The discussion on the Western region is excluded because states of this region only increased in the minimum wage the year 2007. Therefore, the effects for each aggregation version is the same as there is no variation in treatment timing.
