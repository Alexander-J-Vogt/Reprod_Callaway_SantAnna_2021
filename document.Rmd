...
# 3. Aggregated ATT(g,t) according to CS (2021) ----
 ...
 for (i in seq_along(grouplist)) {
  # Selecting the group for which the weight is calculated.
  g <- grouplist[i]
...
if (method == "group_specific_att") {
 ...
 # weights in order to normalize the overall Agg. ATE. The last step is equal to the 
 # kappa of the simple-weighted ATE.
