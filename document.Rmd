...
if (method == "balanced_eventstudy" & !is.null(balanced)) {
 ...
 # the required periods determined by "balanced_group". "groups_to_exclude"
 # is containing the groups, which were not observed for required treatment length.
 groups_to_exclude <- c()
