...
In this section, the original idea of the dynamic TWFE with staggered adoption is repeated with an accompanying explanation and a regression of CS (2021). Furthermore, the challenges of the dynamic TWFE are discussed as well as how the DiD design of CS (2021) solves these challenges.
...
# 3. Aggregated ATT(g,t) according to CS (2021) ----
 ...
 # b) The weights of each group are calculated in this loop,. Therefore, seq_along
