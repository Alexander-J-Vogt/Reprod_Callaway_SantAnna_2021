...
calculating_agg_att <- function(data,
  ...
  for (g in grouplist) {
     for (t in timelist) {
      ...
      # The choice of reference year depends on whether the period of the current 
      ...
      # After having determined the reference year, the dataset can be subsetted
      ...
      # In the next step, the two-year data sets gets further subsetted by only
      ...
      # get a data_sel, which only includes the necessary groups.
