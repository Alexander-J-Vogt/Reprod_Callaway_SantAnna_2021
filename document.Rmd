...
if (method == "calendar_att") {
 ...
 # corresponding weights of each group.
 ...
 for (i in seq_along(calendar_timelist)) {
  ...
  # Secondly, the calendar time effects are calculated by weighting ATT(g,t) with the
  # corresponding weights and divide it by the sum of all used weights in this period.
